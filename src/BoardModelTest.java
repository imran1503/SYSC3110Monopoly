...
public class BoardModelTest {
    ...
    public void testOperateCommandRoll(){
        ...
        BoardView boardView = new BoardView(boardModel);
        boardModel.setBoardView(boardView);
        p1 = new AIPlayer("P1", new Color(10,10,10),1500, 2,boardModel.getBoard(),boardModel, boardView);
        boardModel.addPlayer(p1);
        boardModel.setCurrentPlayer(p1);
    ...
    public void testLanguage(){
        boardModel = new BoardModel("board.xml");
        BoardModel boardModel1 = new BoardModel("board-fr.xml");

        assertEquals("GO", boardModel.getBoard().getProperty(0).getName());
        assertEquals("Départ", boardModel1.getBoard().getProperty(0).getName());

        assertNotEquals("Départ", boardModel.getBoard().getProperty(0).getName());;
        assertNotEquals("GO", boardModel1.getBoard().getProperty(0).getName());;
